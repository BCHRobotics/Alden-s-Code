...
public class RobotMap {
    ...
    //GrabberWrist
    public static int GrabberWristUp = 6;
    public static int GrabberWristDown = 5;

    //AutonomousDrive
    public static int SPARKAUTONOMOUSFORWARD = 1;
    public static int SPARKAUTONOMOUSBACKWARD = 1;
    public static int SPARKAUTONOMOUSLEFT = 1;
    public static int SPARKAUTONOMOUSRIGHT = 1;

    //Lift
    public static int SPARKLIFT = 31;
    ...
    //Encoder PID
    public static double ENCODER_P = 0.001;
    public static double ENCODER_I = 0.001;
    public static double ENCODER_D = 0.001;
    ...
    //Autonomous
    public static int AutoGyro = 1;
    public static int AutoEncoder = 1;
}