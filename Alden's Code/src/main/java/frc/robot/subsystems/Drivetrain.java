...
public class DriveTrain extends Subsystem{
    ...
    TalonSRX GrabberWristUp = new TalonSRX(RobotMap.GRABBERWRISTUP, MotorType.kBrushless);
    TalonSRX GrabberWristDown = new TalonSRX(RobotMap.GRABBERWRISTUP, MotorType.kBrushless);

    MecanumDrive mDrive = null;

    public class autonomous{

    CANSparkMax SPARKAUTONOMOUSFORWARD = new CANSparkMax(Auto.SPARKAUTONOMOUSFORWARD, MotorType.kBrushless);
    CANSparkMax SPARKAUTONOMOUSBACKWARD = new CANSparkMax(Auto.SPARKAUTONOMOUSBACKWARD, MotorType.kBrushless);
    CANSparkMax SPARKAUTONOMOUSLEFT = new CANSparkMax(Auto.SPARKAUTONOMOUSLEFT, MotorType.kBrushless);
    CANSparkMax SPARKAUTONOMOUSRIGHT = new CANSparkMax(Auto.SPARKAUTONOMOUSRIGHT, MotorType.kBrushless);
