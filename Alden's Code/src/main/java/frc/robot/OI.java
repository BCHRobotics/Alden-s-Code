...
public class OI {
    ...
    Button ButtonGrabberWristUp = new JoystickButton(drivestick, RobotMap.OI_DRIVESTICK_GrabberWristUp);
    Button ButtonGrabberWristDown = new JoystickButton(drivestick, RobotMap.OI_DRIVESTICK_GrabberWristDown);
